# python3 testCluster.py input/rake.txt model infer/hdpSparse.txt src/conf/configInferExtFast.json hdp inferTest results/resultsAllCluster.txt
...
if __name__=="__main__":
  ...
  os.system('python3 src/util/createLabels.py '+inferFile+' '+labelsFile)
  labels=[]
